...
vi.mock("../generation/tiktok-script-generator.js", () => ({
...
vi.mock("../platforms/podcast-publisher.js", () => ({
  publishPodcast: vi.fn(),
}));

vi.mock("../generation/instagram-content-generator.js", () => ({
...
vi.mock("../generation/phased-generator.js", () => ({
...
vi.mock("../generation/platform-configs.js", () => ({
  threadsConfig: {
    platform: "threads",
    phases: [],

...
| 「金持ち倒産貧乏倒産を読むをToDoリストに追加してください。」 | 「ToDo追加: 金持ち倒産貧乏倒産を読む」 | ToDo追加は内容も含める |
| 「読書をするをToDoリストに追加してください。」 | 「ToDo追加: 読書」 | |
| 「ひとしとジョジョメン、TODに追加」 | 「ToDo追加: ひとしとジョジョメン」 | |
...
入力: 「本を読むをTuduに追加して」
→ {"intent": "todo", "autonomyLevel": 2, "summary": "ToDo追加", "category": "学習", ...}
理由: 「Tudu」は「ToDo」の表記揺れ。明示的に ToDo への登録を依頼している。

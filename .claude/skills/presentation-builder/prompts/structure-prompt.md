      ...
      "slides": [
        {
          ...
          "purpose": "課題の定量提示",
          "contentHints": [
            "初期ロード: 4.2秒（目標: 1.5秒以下）",
            "JSバンドルサイズ: 2.3MB",
            "LCP: 3.8秒",
            "contentType: key-number"
          ],
    ...
    },
    {
      ...
      "slides": [
        ...
        },
        {
          ...
          "purpose": "処理の流れを図示",
          "contentHints": [
            "サーバー → RSCペイロード → クライアント → 部分ハイドレーション",
        ...
        },
        {
          ...
          "purpose": "従来との違いを明示",
          "contentHints": [
            "useEffect + fetch → サーバーで直接DB問い合わせ",
            "ウォーターフォール解消"
          ]
        }
      ]
